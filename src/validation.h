...
bool AcceptPackageToMemoryPool(CTxMemPool& pool, CValidationState &state, std::list<CTransactionRef>& tx_list,
                               bool* missing_inputs, const CAmount nAbsurdFee, bool test_accept) EXCLUSIVE_LOCKS_REQUIRED(cs_main);
