...
public:
    ...
    void Sort(bool reassign_locations = true, bool reorg=false);
...
private:
    ...
    void RecalculateTxGraphClusterAndMaybeSort(TxGraphCluster *cluster, bool sort, bool reorg=false) EXCLUSIVE_LOCKS_REQUIRED(cs);
