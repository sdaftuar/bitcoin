...
void CheckMempoolV3Invariants(const CTxMemPool& tx_pool, bool check_fees)
{
    ...
    for (const auto& tx_info : tx_pool.infoAll()) {
        ...
        // Transactions with fees of 0 or lower should be proactively trimmed whenever TrimToSize()
        // is called, i.e. when a transaction is successfully submitted to mempool.
