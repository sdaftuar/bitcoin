...
CTxMemPoolEntry::CTxMemPoolEntry(const CTransaction& _tx, const CAmount& _nFee,
                                 ...
                                 bool poolHasNoInputsOf, CAmount _inChainInputValue, unsigned int _sigOps):
    tx(_tx), nFee(_nFee), nTime(_nTime), entryPriority(_entryPriority), entryHeight(_entryHeight),
    hadNoDependencies(poolHasNoInputsOf), inChainInputValue(_inChainInputValue), sigOpCount(_sigOps)
{
