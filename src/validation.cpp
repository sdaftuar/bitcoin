...
bool MemPoolAccept::PolicyScriptChecks(ATMPArgs& args, const CTransactionRef& ptx, Workspace& ws, PrecomputedTransactionData& txdata)
{
    const CTransaction& tx = *ptx;
        ...
        bool test_accept)
{
    ...
    if (!PolicyScriptChecks(args, ptx, workspace, txdata)) return false;
