...
bool MemPoolAccept::ClusterSizeChecks(Workspace& ws)
{
    ...
    auto result{m_pool.CheckClusterSizeLimit(entry.GetTxSize(), 1, m_limits, parents)};
    if (!result) {
...
bool MemPoolAccept::ReplacementChecks(Workspace& ws)
{
    ...
    auto replacement_feerate{m_pool.CalculateMiningScoreOfReplacementTx(*ws.m_entry, ws.m_modified_fees, ws.m_all_conflicting, m_limits)};
