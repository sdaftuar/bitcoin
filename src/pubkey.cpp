...
bool CPubKey::Verify(const uint256 &hash, const std::vector<unsigned char>& vchSig) const {
    ...
    if (!secp256k1_ecdsa_signature_parse_der_lax(secp256k1_context_verify, &sig, &vchSig[0], vchSig.size())) {
        return false;
    }
...
bool ECC_Verify_Start() {
    ...
    secp256k1_context_verify = ctx;
    return true;
}

void ECC_Verify_Stop() {
    secp256k1_context *ctx = secp256k1_context_verify;
