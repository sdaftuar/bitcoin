...
Can also be run manually from the source directory:

test/util/bitcoin-util-test.py --srcdir='.' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/../test/util/data", "bitcoin-util-test.json", buildenv)
