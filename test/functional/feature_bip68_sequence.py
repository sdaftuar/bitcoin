...
class BIP68Test(BitcoinTestFramework):
    ...
    def test_sequence_lock_unconfirmed_inputs(self):
        ...
        # Use prioritisetransaction to lower the effective feerate to 0. Then submit another
        # transaction, triggering the mempool to evict tx2.
        ...
        # Clear prioritisation, resubmit, and mine tx2, and then try again
        self.nodes[0].prioritisetransaction(txid=tx2.hash, fee_delta=int(self.relayfee*COIN))
