...
def main():
    ...
    parser = argparse.ArgumentParser(add_help=False,
                                     usage='%(prog)s [runner.py options] [script options] [scripts]',
                                     description=__doc__,
                                     epilog='''
    ...
    if not test_list:
        print("No valid test scripts specified. Check that your test is in one "
              "of the test lists in runner.py, or run runner.py with no arguments to run all tests")
        sys.exit(0)

    if args.help:
        # Print help for runner.py, then print help of the first script and exit.
        parser.print_help()
...
class RPCCoverage(object):
    """
    Coverage reporting utilities for runner.
