...
class MempoolCoinbaseTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # free_tx's inclusion in a block clears its fee delta. It won't have the priority anymore
        # when it is added to the mempool during the reorg. The mempool isn't trimmed immediately
        # after a reorg, only after another tx is submitted.
