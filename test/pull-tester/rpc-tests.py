...
QA tests are disabled on Windows by default. Use --force to run them anyway.
...
def main():
    ...
    if not (enable_wallet and enable_utils and enable_bitcoind):
        print("No qa tests to run. Wallet, utils, and bitcoind must all be enabled")
    ...
    if args.help:
        ...
        parser.print_help()
        subprocess.check_call((config["environment"]["SRCDIR"] + '/test/qa/' + test_list[0]).split() + ['-h'])
        sys.exit(0)
...
class RPCCoverage(object):
    ...
    See also: test/qa/test_framework/coverage.py
    ...
    def _get_uncovered_rpc_commands(self):
        ...
        """
        # This is shared from `test/qa/test-framework/coverage.py`
