    ...
    def run_test(self):
        ...
        for i in compressed_address:
            ...
            if (v['isscript']):
                ...
                seen_before_add_script.append(p2wsh) # Bare P2WSH derived from a known P2SH with compressed keys should always be seen
                ...
                seen_before_add_script.append(CScript(p2wpkh)) # Bare P2WPKH of a known compressed key should always be seen
